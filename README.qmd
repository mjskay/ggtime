...
pedestrian[
  with(pedestrian, Sensor == "Southern Cross Station" & Date < "2015-03-01"),
] |>
  autoplot(Count) +
  # coord_calendar(xlim = c(Sys.time(), Sys.Date() + lubridate::days(1)))
  ggplot2::coord_trans(
    x = cal_trans_x(),
    xlim = as.POSIXct(c("2024-03-25 00:00:00", "2024-03-31 23:59:59"))
  ) +
...
pedestrian[
  ...
  ggplot2::scale_x_continuous(
    transform = cal_trans_x(),
    limits = as.POSIXct(c("2024-03-25 00:00:00", "2024-03-31 23:59:59"))
  ) +
  coord_polar()
```
